...
func (base *Controller) DebitWallet(c *gin.Context) {
	var (
		req models.DebitWalletRequest
	)
	...
	rd := utility.BuildSuccessResponse(http.StatusOK, "wallet debited", walletBalance)
	c.JSON(http.StatusOK, rd)

}

func (base *Controller) CreditWallet(c *gin.Context) {
	var (
		req models.CreditWalletRequest
	)
	...
	rd := utility.BuildSuccessResponse(http.StatusOK, "wallet credited", walletBalance)
	c.JSON(http.StatusOK, rd)
